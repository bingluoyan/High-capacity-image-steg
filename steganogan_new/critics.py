...
class BasicCritic(nn.Module):
    ...
    def _build_models(self):
        return nn.Sequential(
            spectral_norm(self._conv2d(3, self.hidden_size)),
            nn.LeakyReLU(inplace=True),
            # nn.BatchNorm2d(self.hidden_size),

            spectral_norm(self._conv2d(self.hidden_size, self.hidden_size)),
            nn.LeakyReLU(inplace=True),
            # nn.BatchNorm2d(self.hidden_size),
            ...
            spectral_norm(self._conv2d(self.hidden_size, 1))
        )
